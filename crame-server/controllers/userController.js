...
const loginUser = async (req, res) => {
  try {
    ...
    // Enhancement 1: Explicitly block Viewers from logging in
    if (user.type === 'viewer') {
        return res.status(403).json({ message: 'Access Denied: Viewers are not authorized to access the portal.' });
    }
